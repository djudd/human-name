...
fn matches_without_diminutive(a: &str, b: &str) -> bool {
    if a.len() > 2 && a.ends_with('y') && have_prefix_match!(a[0..a.len()-1], b) {
        true
    } else if a.len() > 4 && a.ends_with("ie") && have_prefix_match!(a[0..a.len()-2], b) {
        true
    } else if a.len() > 5 && b.ends_with('a') && a.ends_with("ita") && have_prefix_match!(a[0..a.len()-3], b) {
        true
...
static NAMES_BY_NICK: phf::Map<&'static str, phf::Set<&'static str>> = phf_map! {
    ...
    "Angela" => phf_set! { "Angelica", "Angelina", "Angeline" },
    ...
    "Dora" => phf_set! { "Dorothy", "Eudora", "Isidora", "Pandora", "Theodosia" },
    "Dori" => phf_set! { "Dora" },
    ...
    "Laura" => phf_set! { "Laurinda", "Loretta", "Marialaura", "Lauri" },
    ...
    "Paula" => phf_set! { "Paulina", "Anapaula" },
