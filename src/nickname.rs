...
static NAMES_BY_NICK: phf::Map<&'static str, phf::Set<&'static str>> = phf_map! {
    ...
    "Paula" => phf_set! { "Paulina", "Paulita", "Anapaula" },
    "Pauli" => phf_set! { "Paula", "Paulina", "Paulita" },
    "Pauline" => phf_set! { "Paulina" },
    "Pauly" => phf_set! { "Paulina", "Paula", "Paulita" },
    "Pawel" => phf_set! { "Paweł" },
    ...
    "Ravi" => phf_set! { "Ramakrishna", "Ravishankar" },
    ...
    "Sue" => phf_set! { "Susannah", "Susan" },
    "Sul" => phf_set! { "Raisul", "Samsul" },
    "Sumi" => phf_set! { "Mousumi" },
    "Susie" => phf_set! { "Susan", "Susannah" },
    "Susi" => phf_set! { "Susan", "Susannah" },
    "Susy" => phf_set! { "Susan", "Susannah" },
    "Susana" => phf_set! { "Susannah" },
    "Susanna" => phf_set! { "Susannah" },
    "Suzanne" => phf_set! { "Susannah" },
    "Susanne" => phf_set! { "Susannah" },
    ...
    "Theodore" => phf_set! { "Theodorick", "Theodrick" },
